classdef TennisBallNewtonianGravity < matlab.unittest.TestCase
    properties (Access = private)
        BaselineFilename = 'TennisBallNewtonianGravityBaseline.mat';
    end
    ...
    methods (Test)
        function RunAndCompare(obj)
            ...
            settings.x0 = 10000;
            settings.v0 = 0;
            settings.gravityField = Selections.GravityFieldType.Newtonian;
